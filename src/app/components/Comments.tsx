...
import convertDateToRelativeTime from "@/app/utils/relativeTime";
...
const Comments = ({
    ...
    const handleSubmit = async (e:React.FormEvent<HTMLFormElement>)=>{
        ...
        try{
            ...
            window.alert(error?.message||"error creating document")
        }
    }
    const deleteComment = async (commentId:string)=>{
        try{
            ...
            window.alert(error?.message||"Error while deleting comment")
        }
    }
    return (
